    ...
    <section className="prices" id="prices">
      ...
      <ul>
        <li>
          ...
          смонтировать аудио ролик и сделать видео ролик стоимостью от{" "}
          <b>1000</b> рублей!
        </li>
        <li>
        ...
        <li>
          ...
          <br />
          Вы не просто перечисляете деньги, а именно по договору оказания услуг
        </li>
        <li>
          <b>Эксклюзивность данной рекламы</b>
          <br />
          Пока ещё мало людей, использующих для продвижения своего бизнеса аудио
          и видео рекламу в ВК
        </li>
      </ul>
    </section>
  )
