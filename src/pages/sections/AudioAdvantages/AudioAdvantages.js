...
function AudioAdvantages() {
  return (
    <section className="audio__advantages">
      <h3>Плюсы аудиорекламы</h3>
      <ul>
        <li>
          <b>Выделяет среди конкурентов</b>
          <br />
          Аудиорекламой пользуются крупные бренды, поэтому слушатель будет
        ...
        <li>
          ...
          возрасту, геолокации (дом, работа), уровню доходов, интересам и
          многому другому, или же можно настроиться на пользователей групп в ВК
          ваших конкурентов. Также по дням недели и времени, когда вам это
          нужно.
        </li>
        <li>
          <b>Слушают всё ОТ и ДО</b>
          <br />
          Аудиорекламу не промотать, поэтому человек будет слушать ваше
